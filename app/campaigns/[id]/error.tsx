    ...
    <main className="mx-auto flex w-full max-w-2xl flex-1 items-center px-6 py-12">
      <Card className="w-full border-destructive/40">
        <CardContent className="flex flex-col gap-4 p-6">
          <h1 className="text-lg font-semibold">The campaign dashboard could not be rendered</h1>
          <p className="text-muted-foreground text-sm">{error.message || 'Try loading the dashboard again.'}</p>
